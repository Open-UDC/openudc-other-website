...
print "</h2>";
print "<p>";
printf(_("OpenUDC is a set of free softwares designed to create a free money system based on a decentralized human P2P network."));
print "</p>";
print "<p>";
...
print "</p>";
print "<p>";
printf(_("OpenUDC allow each community who want to use its own free money to describe its own Universal Dividend set of rules."));
print "</p>";
print "<h3>";
...
print "</p>";
print "<p>";
printf(_("A new member entering the money system has to be signed by a determined (parameter of the money system) number of existing members. A member yet existing in the money system has to renew periodically signing in a period of time (other parameter of the money system), as a renewable proof of life. "));
print "</p>";
print "<p>";
printf(_("So there is no center, no centralized organism in an OpenUDC money system."));
print "</p>";
print "<h3>";
printf(_("Exchanges"));
print "</h3>";
...
print "</h3>";
print "<p>";
printf(_("A node is an instance of OpenUDC software, connected to other nodes. All those P2P connected nodes know the OpenUDC Web of Trust, and share the same database in a synchronized way. So the database itself is a P2P shared database containing the whole Monetary Mass. So each member of an OpenUDC money system can have its own node and own copy of the updated OpenUDC Web of Trust and OpenUDC Monetary Mass. "));
print "</p>";
...
print "</p>";
print "<p>";
printf(_("Note1 : OpenUDC system has to show always the information on a relative units, so quantitative units can be seen only for technical base. On its own account a member has a number a quantitative units Q, he can count on number of Universal Dividend making the calculation account : Q / UD."));
print "</p>";
print "<p>";
