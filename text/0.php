...
print "</p>";
print "<p>";
printf(_("A new member entering the money system has to be signed by a determined (parameter of the money system) number of existing members."));
print "</p>";
print "<p>";
printf(_("A member yet existing in the money system has to renew periodically signing in a period of time (other parameter of the money system), as a renewable proof of life. "));
print "</p>";
print "<p>";
...
print "</h3>";
print "<p>";
printf(_("A node is an instance of OpenUDC software, connected to other nodes. All those P2P connected nodes know the OpenUDC Web of Trust, and share the same database in a synchronized way. So the database itself is a P2P shared database containing the whole Monetary Mass."));
print "</p>";
print "<p>";
printf(_("Each member of an OpenUDC money system can have its own node and own copy of the updated OpenUDC Web of Trust and OpenUDC Monetary Mass. "));
print "</p>";
...
print "</p>";
print "<p>";
printf(_("The OpenUDC digital coins are all in the P2P shared database, and so there is no possibility for those coins to be lost."));
print "</p>";
print "<h3>";
